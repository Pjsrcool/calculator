...
var ButtonPanel = /*#__PURE__*/function (_React$Component) {
  _inherits(ButtonPanel, _React$Component);

  var _super = _createSuper(ButtonPanel);
  ...
  function ButtonPanel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (buttonName) {
...
_defineProperty(ButtonPanel, "propTypes", {
